...
ui <- navbarPage(paste("ISLA:", your_school_name, current_school_year), theme = shinytheme("flatly"),
        tabPanel("School", icon = icon("school"),
          sidebarPanel(width = 3,
            radioButtons("grade_level", "Select grade:", choices = grade_choices),
          ...
          mainPanel(
            ...
            tabsetPanel(type = "pills",
              tabPanel("ISLA", icon = icon("square-check"),
                fluidRow(
              ...
              tabPanel("Incidents", icon = icon("list-ol"),
                fluidRow(
                  ...
                  box(title = "Number of Students in Room",
        ...
        tabPanel("Student", icon = icon("user"),
          ...
          mainPanel(
            tabsetPanel(type = "pills",
              ...
              tabPanel("ISLA Fidelity", icon = icon("square-check"),
                       fluidRow(
